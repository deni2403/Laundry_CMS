        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->role == 'superadmin')
                    <x-nav-link :href="route('createOrder.superadmin')" :active="request()->routeIs('createOrder.superadmin')">
                        {{ __('Orders') }}
                    </x-nav-link>
                    @endif
                    ...
                    @if (Auth::user()->role == 'cashier')
                    <x-nav-link :href="route('createOrder.cashier')" :active="request()->routeIs('createOrder.cashier')">
                        {{ __('Orders') }}
                    </x-nav-link>
                    @endif
